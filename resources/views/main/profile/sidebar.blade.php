<div class="md:w-1/3">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 text-center mb-6">
        <div class="relative inline-block">
            <img src="{{ asset($freelancer->profile_image) }}" alt="{{ $freelancer->user->name }}"
        ...
        <div class="space-y-3">
            ...
            <button
                class="w-full border border-primary text-primary hover:bg-blue-50 font-bold py-3 px-4 rounded-lg transition duration-300">
