...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <h2 class="mb-3 text-uppercase" dir="rtl">تعديل الشركة</h2>

            <div class="card" dir="rtl">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form method="POST" action="{{ route('companies.update', $company) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                                <label for="business_field" class="form-label">مجال العمل</label>
                                <textarea class="form-control" id="business_field" name="business_field" rows="2">{{ old('business_field', $company->business_field) }}</textarea>
                            ...
                            <div class="col-md-3">
                                ...
                                @if ($company->logo != null)
                                    <img src="{{ asset($company->logo) }}" alt="شعار الشركة" class="img-thumbnail mb-2" style="max-width: 150px;">
                                @endif
