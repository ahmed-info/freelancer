...
<nav class="bg-white shadow-md sticky top-0 z-50">
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-white shadow-lg absolute top-16 left-0 w-full z-40">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="{{ route('freelance.main') }}" class="text-gray-700 hover:text-primary block px-3 py-2 rounded-md text-base font-medium transition duration-300">المستقلون</a>
        ...
        <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
            <p class="text-sm text-blue-800 text-right">
                <i class="fas fa-info-circle ml-2"></i>
                 انضم كمقدم خدمة او صاحب مشروع او صاحب شركة
            </p>
        </div>
        ...
        <form action="{{ route('register') }}" method="POST" class="mt-4">
            ...
            <div class="relative mb-2">
                    <select name="role" id="role" required
                        class="custom-select w-full py-2 px-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent appearance-none bg-white transition-all duration-200">
                        <option value="">اختر نوع الحساب</option>
                        <option value="freelance">مقدم خدمة</option>
                        <option value="project">صاحب مشروع</option>
                        <option value="company">صاحب شركة</option>
                    </select>
