...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    ...
                    <nav class="hidden md:flex space-x-8 space-x-reverse mr-8">
                        ...
                        <a href="#" class="text-gray-700 hover:text-primary">المستقلون</a>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600">أضف تفاصيل مشروعك لتبدأ في تلقي عروض من المستقلين الموهوبين</p>
        </div>
        ...
        <form id="project-form" action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="project-details" name="description" rows="6"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                        placeholder="أدخل وصفاً مفصلاً لمشروعك، المهام المطلوبة، النتائج المتوقعة، وأي معلومات أخرى تساعد المستقلين على فهم متطلباتك"></textarea>
            ...
            <div class="form-section">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-sm text-gray-500 mt-1">أضف المهارات الأساسية التي يجب أن يمتلكها المستقل لتنفيذ
                        مشروعك</p>
                </div>
            ...
            <div class="form-section">
                ...
                <div id="hourly-budget" class="mb-4 hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="weekly-hours" class="block text-gray-700 mb-2">عدد الساعات أسبوعياً</label>
                            <select id="weekly-hours"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                                <option value="10">أقل من 10 ساعات</option>
                                <option value="20">10 - 20 ساعة</option>
                                <option value="30">20 - 30 ساعة</option>
                                <option value="40">30 - 40 ساعة</option>
                                <option value="40+">أكثر من 40 ساعة</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition">المستقلون</a></li>
            ...
            budgetTypeRadios.forEach(radio => {
                radio.addEventListener('change', function() {
                    if (this.value === 'fixed') {
                        ...
                        document.getElementById('budget-amount').setAttribute('required',
                            'required');
                    } else {
                        fixedBudget.classList.add('hidden');
                        hourlyBudget.classList.remove('hidden');
                        ...
                        document.getElementById('weekly-hours').setAttribute('required',
                        'required');
                    }
                });
            });
