        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center">
                    ...
                    <a href="./register.html" class="bg-primary hover:bg-secondary text-white px-4 py-2 rounded-md text-sm font-medium transition duration-300 transform hover:scale-105 animate-pulse-glow">انضم كمقدم خدمة</a>
                </div>
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden hidden bg-white shadow-lg absolute top-16 left-0 w-full">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <div class="border-t border-gray-200 pt-4">
                    ...
                    <a href="./register.html" class="bg-primary hover:bg-secondary text-white block px-3 py-2 rounded-md text-base font-medium mt-2 transition duration-300 transform hover:scale-105">انضم كمقدم خدمة</a>
                </div>
            </div>
        </div>
    </nav>
